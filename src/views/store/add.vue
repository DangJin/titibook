<template>
  <div id="add-store">
    <div class="title"><i class="el-icon-arrow-left"></i> 添加门店</div>
    <el-steps :active="active.step" finish-status="success" align-center>
      <el-step title="添加基本信息" icon="el-icon-edit"></el-step>
      <el-step title="添加地理位置" icon="el-icon-upload"></el-step>
      <el-step title="上传店铺图片" icon="el-icon-picture"></el-step>
    </el-steps>
    <div class="content">
